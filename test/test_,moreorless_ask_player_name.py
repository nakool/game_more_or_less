...
from moreorless import ask_player_name, DEFAULT_PLAYERNAME_MIN_LENGHT, DEFAULT_PLAYERNAME_MAX_LENGHT
...
def test_ask_player_name_empty(magic_mock):
    ...
    assert ask_player_name(min_lenght=DEFAULT_PLAYERNAME_MIN_LENGHT,
